...
const Hero = () => {
    return (
        <section id='hero' className='bg-[#31065A] max-lg:py-16 max-sm:pt-0 max-sm:pb-16'>
            <div className='max-w-[1250px] mx-auto'>
                <div className='flex items-center justify-between gap-10 max-sm:flex-col-reverse max-lg:flex-col'>
                    <div className='grid gap-3 max-sm:gap-5 w-[50%] max-lg:w-full max-lg:px-10 max-lg:text-center' data-aos="fade-up">
                        ...
                        <div className='flex items-center gap-5 mt-3 max-lg:justify-center'>
                    ...
                    <img src={Banner} alt="" data-aos="fade-up" className='max-lg:hidden max-sm:block' />
                </div>
            </div>
        </section>
    )
